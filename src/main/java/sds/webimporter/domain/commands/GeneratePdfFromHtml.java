...
public class GeneratePdfFromHtml extends AbstractContract {
    ...
    public GeneratePdfFromHtml() {
        ...
        contractName = GeneratePdfFromHtml.class.getSimpleName();
    }
    ...
    public String toString() {
        return String.format("%s [id=%s, bucket=%s, userId=%s, namespace=%s, contractName=%s, correlationId=%s]",
                GeneratePdfFromHtml.class.getSimpleName(), id, bucket, userId, namespace, contractName, getCorrelationId());
    }
